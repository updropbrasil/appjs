  ...
  async function testarHook() {
    ...
    try {
      const r = await fetch(hook.trim(), {
        ...
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          evento: 'lead_novo', teste: true, origem: 'Teste do admin',
          canal: 'CLICK_WHATSAPP', temperatura: 'Alta', transacao: 'RENT',
          nome: 'Cliente Teste', telefone: '83999282626', whatsapp: '5583999282626',
          whatsapp_link: 'https://wa.me/5583999282626?text=teste',
          mensagem_sugerida: 'Olá Cliente! Aqui é da Jason Dias Imóveis…',
          email: 'teste@exemplo.com', codigo_imovel: 'JDA-0000',
          imovel: { titulo: 'Apartamento teste', bairro: 'Cabo Branco', finalidade: 'aluguel', preco: 6500, link: `${SITE_URL}/` },
