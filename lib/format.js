...
export function ytEmbed(id, { autoplay = 1, mute = 1, controls = 1, loop = 1, origin = '' } = {}) {
  if (!id) return '';
  ...
  // domínio padrão do YouTube é mais tolerante a embed do que o nocookie em alguns vídeos
...
// só dígitos -> "6.500" (máscara de milhar, para inputs de dinheiro)
export function maskThousands(str) {
